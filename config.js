...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '*MADE BY ༒♧-𝐋𝐀 𝐕𝐎𝐒𝐓𝐈-☆༒' : process.env.ALL_CAPTION,
    ...
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? '༒♧-𝐋𝐀 𝐕𝐎𝐒𝐓𝐈-☆༒ is ALIVE' : process.env.ALIVE_MESSAGE,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'ADIOS MOFO 😂' : process.env.KICKME_MESSAGE,
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '97470463628@s.whatsapp.net' : process.env.TAG_REPLY,
    NBSK: process.env.ALL_NUMBER === undefined ? '97470463628' : process.env.ALL_NUMBER,
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '༺ 𒆜𝑙𝑎 𝑣𝑜𝑠𝑡𝑖_𝑏𝑜𝑡𒆜 ༻;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? '༒♧-𝐋𝐀 𝐕𝐎𝐒𝐓𝐈-☆༒' : process.env.OWNER_NAME,
    ...
    def_st_name: process.env.DF_STICKER_NAME === undefined ? '༒♧-𝐋𝐀 𝐕𝐎𝐒𝐓𝐈-☆༒' : process.env.DF_STICKER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '༒♧-𝐋𝐀 𝐕𝐎𝐒𝐓𝐈-☆༒' : process.env.BOT_NAME,
    ...
    SLINK: process.env.IG === undefined ? 'instagram.com/lavostii' : process.env.IG,
    ...
    SOURAVKL11: process.env.STICKER_DATA === undefined ? '༺ 𒆜𝑙𝑎 𝑣𝑜𝑠𝑡𝑖_𝑏𝑜𝑡𒆜 ༻' : process.env.STICKER_DATA,
    ANTI_FAKE: process.env.AUTO_FAKE === undefined ? 'lavosto' : process.env.AUTO_FAKE,
    ...
    TAGALL: process.env.TAG_HEADER === undefined ? '*build by ༒♧-𝐋𝐀 𝐕𝐎𝐒𝐓𝐈-☆༒*' : process.env.TAG_HEADER,
    SKV: process.env.V_HEADER === undefined ? '*༺ 𒆜𝑙𝑎 𝑣𝑜𝑠𝑡𝑖_𝑏𝑜𝑡𒆜 ༻*' : process.env.V_HEADER,
    ...
    SUDO: process.env.SUDO === undefined ? '97470463628' : process.env.SUDO,
    DEBUG: DEBUG,
    COFFEEHOUSE_API_KEY: process.env.COFFEEHOUSE_API_KEY === undefined ? false : process.env.COFFEEHOUSE_API_KEY,
    WITAI_API: "TEYMELA6DMC4XB5YM3SPTTQWUUIBKURG",
    SUPPORT2: "254799173650",
    SUPPORT3: "97470463628",
    ST:"https://gist.github.com/Lavosti001/",
